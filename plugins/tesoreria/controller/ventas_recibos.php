...
class ventas_recibos extends fs_controller
{
   ...
   protected function private_core()
   {
      ...
      else
      {
         ...
         if($this->cliente)
         {
            $this->b_url .= '&codcliente='.$this->cliente->codcliente;
         }
   ...
   private function share_extenstion()
   {
      ...
      $fsext0->to = 'ventas_factura';
      $fsext0->type = 'tab';
      $fsext0->text = '<span class="glyphicon glyphicon-piggy-bank" aria-hidden="true"></span><span class="hidden-xs">&nbsp; Recibos</span>';
      $fsext0->save();
      ...
      $fsext1->to = 'editar_factura';
      $fsext1->type = 'tab';
      $fsext1->text = '<span class="glyphicon glyphicon-piggy-bank" aria-hidden="true"></span><span class="hidden-xs">&nbsp; Recibos</span>';
      $fsext1->save();
      ...
      $fsext5->to = 'ventas_facturas';
      $fsext5->type = 'hidden_iframe';
      $fsext5->params = '&cronjob=TRUE';
      $fsext5->save();
      
      /// metemos el iframe en el megafacturador
      $fsext6 = new fs_extension();
      $fsext6->name = 'if_megafacturador';
      $fsext6->from = __CLASS__;
      $fsext6->to = 'megafacturador';
      $fsext6->type = 'hidden_iframe';
      $fsext6->params = '&cronjob=TRUE';
      $fsext6->save();
      
      /// metemos el iframe en las remesas
      $fsext7 = new fs_extension();
      $fsext7->name = 'if_remesas';
      $fsext7->from = __CLASS__;
      $fsext7->to = 'remesas';
      $fsext7->type = 'hidden_iframe';
      $fsext7->params = '&cronjob=TRUE';
      $fsext7->save();
   }
