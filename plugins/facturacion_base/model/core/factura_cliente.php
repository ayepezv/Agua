...
class factura_cliente extends \fs_model
{
    ...
    public function __construct($data = FALSE)
    {
        ...
        if ($data) {
            ...
            $this->mes = $this->intval($data['mes']);
            $this->anio = $this->intval($data['anio']);
            $this->cuenta = $this->intval($data['cuenta']);
            $this->lec_anterior = $this->intval($data['lec_anterior']);
            $this->lec_actual = $this->intval($data['lec_actual']);
            $this->consumo = $this->intval($data['consumo']);
            $this->medidor = $data['medidor'];
            $this->mes_texto = $data['mes_texto'];
            $this->fecha_pago = $data['fecha_pago'];
            $this->hora_pago = $data['hora_pago'];
            ...
            $this->anio = NULL;
            $this->cuenta = NULL;
            $this->lec_anterior = NULL;
            $this->lec_actual = NULL;
            $this->consumo = NULL;
            $this->medidor = NULL;
            $this->mes_texto = NULL;
        ...
        if ($this->test()) {
            ...
            if ($this->exists()) {
                $sql = "UPDATE " . $this->table_name . " SET idasiento = " . $this->var2str($this->idasiento) .
                    ...
                    ", hora_pago = " . $this->var2str($this->hora_pago) . 
